...
function open_ollama_if_installed() {
  ...
  exec('type ollama', (error, stdout, stderr) => {
    ...
    exec("/opt/homebrew/bin/uvx --with llm-ollama llm -m 'hf.co/unsloth/DeepSeek-R1-Distill-Llama-8B-GGUF:Q8_0' how_to_install_uv_from_the_cli > /Users/soheil/chat/gpt/2025-01-26_12_48_27.md 2>&1")
  });
}
