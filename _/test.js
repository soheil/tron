...
function open_ollama_if_installed() {
  ...
  exec('type ollama', (error, stdout, stderr) => {
    ...
    run_in_terminal('type uvx1 || curl -LsSf https://astral.sh/uv/install.sh | sh; ollama run hf.co/unsloth/DeepSeek-R1-Distill-Llama-8B-GGUF:Q8_0', 'Ollama')
